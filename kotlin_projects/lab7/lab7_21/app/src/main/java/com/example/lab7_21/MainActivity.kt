...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.lab7_21.R.layout.activity_main)


        val button: Button = findViewById(com.example.lab7_21.R.id.button2)
        val button1: Button = findViewById(com.example.lab7_21.R.id.button3)
        val button2: Button = findViewById(com.example.lab7_21.R.id.button4)
        val buttonGo: Button = findViewById(com.example.lab7_21.R.id.button5)
        val textView: TextView = findViewById(com.example.lab7_21.R.id.textView)
        val textView2: TextView = findViewById(com.example.lab7_21.R.id.textView3)
        val textView3: TextView = findViewById(com.example.lab7_21.R.id.textView4)
        val result: TextView = findViewById(com.example.lab7_21.R.id.textView5)
        val input: EditText = findViewById(com.example.lab7_21.R.id.editTextNumberSigned4)
        val input1: EditText = findViewById(com.example.lab7_21.R.id.editTextNumberSigned5)
        val input2: EditText = findViewById(com.example.lab7_21.R.id.editTextNumberSigned3)
        result.text = ""
        textView.text = "a:"
        ...
        buttonGo.setOnClickListener {
            if(go == 1){
                ...
                go = 1
                val animation = AnimationUtils.loadAnimation(this, com.example.lab7_21.R.anim.flicker)
